...
test_that("The output is correct for train/test split", {
  ...
  expect_equal(nrow(x[[2]]@data), length(x[[2]]@pa))
  expect_equal(nrow(x[[2]]@coords), length(x[[2]]@pa))
...
test_that("The output is correct for train/val/test split", {
  ...
  expect_equal(nrow(x[[3]]@data), length(x[[3]]@pa))
  expect_equal(nrow(x[[3]]@coords), length(x[[3]]@pa))
